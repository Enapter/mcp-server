...
class TestDeviceSpecification:
    def test_matches_name(self) -> None:
        ...
        assert (
            spec.matches(
                domain.Device(
                    id="2", name="Beta", site_id="s1", type=domain.DeviceType.NATIVE
                )
            )
            is False
        )
    ...
    def test_matches_type(self) -> None:
        ...
        assert (
            spec.matches(
                domain.Device(
                    id="1", name="A", site_id="s1", type=domain.DeviceType.GATEWAY
                )
            )
            is True
        )
        assert (
            spec.matches(
                domain.Device(
                    id="2", name="A", site_id="s1", type=domain.DeviceType.NATIVE
                )
            )
            is False
        )
    ...
    def test_matches_site_id(self) -> None:
        ...
        assert (
            spec.matches(
                domain.Device(
                    id="1", name="A", site_id="s1", type=domain.DeviceType.NATIVE
                )
            )
            is True
        )
        assert (
            spec.matches(
                domain.Device(
                    id="2", name="A", site_id="s2", type=domain.DeviceType.NATIVE
                )
            )
            is False
        )
