...
class Client:
    ...
    def __init__(self, url: str, enapter_auth_token: str | None = None) -> None:
        self._client = self._new_client(url, enapter_auth_token)

    def _new_client(self, url: str, enapter_auth_token: str | None) -> fastmcp.Client:
        headers = {}
